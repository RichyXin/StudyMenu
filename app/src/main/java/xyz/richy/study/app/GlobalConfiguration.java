...
import me.jessyan.mvparms.study.BuildConfig;
import me.jessyan.mvparms.study.R;
import okhttp3.Interceptor;
import okhttp3.Request;
import okhttp3.Response;
import timber.log.Timber;
import xyz.richy.study.mvp.model.api.Api;
...
//                    retrofitBuilder.addConverterFactory(FastJsonConverterFactory.create());//比如使用fastjson替代gson
    ...
    public void registerComponents(Context context, IRepositoryManager repositoryManager) {
        repositoryManager.injectRetrofitService(xyz.richy.study.mvp.model.api.service.CommonService.class, xyz.richy.study.mvp.model.api.service.UserService.class);
